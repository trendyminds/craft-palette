	...
	return (
		<div
			className={clsx(
				...
				'vtw-rounded-[8px] vtw-overflow-hidden vtw-shadow-2xl',
		...
		>
			<input
				...
				placeholder="Search"
				className={clsx(
					'vtw-w-full vtw-font-sans vtw-py-3 vtw-px-5 vtw-text-[16px]',
					...
					return (
						<a
							...
							className={clsx(
								...
								'vtw-font-sans vtw-text-[14px] vtw-text-gray-800 dark:vtw-text-neutral-300',
								'vtw-p-2 vtw-mx-2',
								'vtw-rounded-[8px]',
								'vtw-no-underline hover:vtw-no-underline',
								isLast && 'vtw-mb-2',
							...
							>
								<div className={clsx('vtw-flex vtw-flex-col vtw-gap-1')}>
									...
									{option.subtitle && (
										<span
											className={clsx(
												'vtw-block vtw-leading-none vtw-text-[12px] vtw-text-gray-500 dark:vtw-text-neutral-400 vtw-m-0 vtw-font-sans'
											)}
										>
											{option.subtitle}
										</span>
